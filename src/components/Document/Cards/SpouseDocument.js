...
const SpouseDocument = ({ obj, handleShowImageModal }) => {
	return (
		<Col
			md={4}
			style={{
			...
			<Col>
				{obj?.spouseDocument === null && !obj?.docStatus?.spouseDocument && (
					<Button
						className='w-100 p-0 ms-0'
						onClick={
							obj?.spouseDocument === null
								? null
								: () =>
				...
				{obj?.spouseDocument && !obj?.spouseDocument?.approved && (
					<Button
						className='w-100 p-0 ms-0'
						onClick={
							obj?.spouseDocument === null
				...
				{obj?.spouseDocument === null && obj?.docStatus?.spouseDocument && (
					<Button
						...
						onClick={
							obj?.spouseDocument === null
								? null
								: () => handleShowImageModal(obj, "spouseDocument")
						}
