...
const Sidebar = ({ setShowSide, showSide }) => {
  ...
  const [link, setLink] = useState([
    ...
    },
    {
      ...
      permission: permissions?.newUser,
    },
    {
      active: false,
      name: "Contratos",
      idName: "ContratosMenu",
      link: "/contratos",
      color: "#c8c8c8",
      svg: "M8.75 5.8125C8.75 6.35938 9.14062 6.75 9.6875 6.75H15V19.5625C15 20.1094 14.5703 20.5 14.0625 20.5H0.9375C0.390625 20.5 0 20.1094 0 19.5625V1.4375C0 0.929688 0.390625 0.5 0.9375 0.5H8.75V5.8125ZM15 5.26562V5.5H10V0.5H10.2344C10.4688 0.5 10.7031 0.617188 10.8984 0.773438L14.7266 4.60156C14.8828 4.79688 15 5.03125 15 5.26562Z",
    ...
    <>
      ...
      >
        <Col md={12} style={{ height: "100%" }}>
              ...
              return (
                <>
                  <Row
                    id={val.idName}
                    key={index}
                    className="mt-4 c-point"
                    onClick={() => nextShowPopUp(index)}
                  >
                    <Col
                      md={5}
                      xs={5}
          ...
          <Row className="mt-5 d-flex align-items-end flex-column sidebarLogout">
