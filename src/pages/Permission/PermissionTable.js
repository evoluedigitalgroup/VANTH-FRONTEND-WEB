...
const PermissionTable = ({ tableRow, refresh, setRefresh }) => {
                ...
                <tr key={i} style={{ fontSize: "14px" }}>
                    ...
                    {val.permissions["insights"] ? (
                      ...
                      >
                        <span className="d-flex align-items-center">
                          <img src="/assets/img/right 2.png" className="px-1" />
                          Autorizar
                        </span>
                      </Button>
                    ) : (
                      ...
                      >
                        ...
                        >
                          <img src="/assets/img/wrong.png" className="px-1" />
                          Remover
                        </span>
                      </Button>
                    )}
                  ...
                  <td>
                    {val.permissions["permissions"] ? (
                      <Button
                        onClick={(e) =>
                          handleClick(e, val, "permissions", true)
                        }
                        variant=" success"
                        size="lg"
                        style={{ fontSize: "14px" }}
                      ...
                      <Button
                        onClick={(e) =>
                          handleClick(e, val, "permissions", false)
                        }
                        variant="danger"
                        size="lg"
                        style={{ fontSize: "14px" }}
